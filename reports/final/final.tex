...
only reduced the prediction accuracy by ...
...
A good language for writing data wrangling tools is simple, easy to compile and
run, easy to prototype in and has a good standard library for I/O and parsing
common file formats. Go was picked due to my fluency in the language and because
it fits all the requirements for writing such tools.
...
\emph{autoincr} was implemented in Go. It takes a CSV edge list as input and it
outputs
