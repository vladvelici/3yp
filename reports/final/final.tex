...
vertices in a graph only by looking at its structure. Then if a cloud vector is
...
the complex conjugate has also been computed. If these conditions are not met for
...
\addcontentsline{toc}{section}{Appendix A - Project Gantt Chart}
\begin{figure}[hft]
\begin{center}
...
\ganttbar{Graph processing tools}{12}{14} \\
\ganttbar{(Limited) Evaluation in Matlab}{14}{15} \\
\ganttbar{Choose language to port algorithm}{15}{17} \\
\ganttbar{Implement in Python}{17}{20} \\
\ganttbar{Max. depth heuristic}{20}{21} \\
\ganttbar{Directed math and implementation}{21}{25} \\
\ganttbar{cmd.py evaluation on SNAP Fb.}{23}{28} \\
\ganttbar{Graphviz visualisation}{28}{29} \\
\ganttbar{Write final report}{27}{30} \\
