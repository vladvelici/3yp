...
\begin{align}
  ...
  \mat{Z}_{ij} &= \frac{\bm{\vee}^{(j)}_i \mat{W}^{\sfrac{-1}{2}}_{ii}}
    {1-\mu \lambda_j},
\end{align}
or vectorised using a new $m \times m$ diagonal matrix $\mat{R}$,
\begin{align}
...
%% TO_WRITE: CHOLESKY DECOMPOSITION AND FINAL DOT PRODUCT FOR UNDIRECTED.

\subsection{Directed graphs}

%% TO_WRITE: ALL THE DIRECTED MATHS
