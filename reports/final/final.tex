...
The friends dataset was transformed in a CSV edge list graph where a vertex
represents a person and an edge represents a bidirectional friendship. The graph
has $26,457$ vertices and $372,227$ undirected edges, but it is divided into
$378$ connected components. The largest connected components (by the number
of vertices) are the following:

\begin{lstlisting}
  Component    Vertices  Edges
  4_all.csv    2212      41552
  10_all.csv   1700      36179
  3_all.csv    1304      23029
  5_all.csv    1216      13772
  9_all.csv    942       6743
  23_all.csv   724       14712
  8_all.csv    653       21597
  27_all.csv   630       7865
  14_all.csv   617       9446
  39_all.csv   527       24838
  45_all.csv   442       5547
  21_all.csv   435       6334
\end{lstlisting}
