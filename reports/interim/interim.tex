...
\end{equation}
%
Plug \emph{Equation~\ref{eq:observe-scalar}} and \emph{Equation~\ref{eq:geometric-series}} back into \emph{Equation~\ref{eq:ci-rearranged}} and obtain:
\begin{equation}
...
%% Define Z
%
To simplify \emph{Equation~\ref{eq:ci-rearranged-geometric}}, let $Z$ be a matrix such that:
\begin{equation}
\label{eq:z-ij}
